<x-app>
    ...
    <form method="POST" action="{{ route('categories.update', $category->id) }}">
        ...
        <div class="mb-3">
            ...
            <input type="string" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name', $category->name) }}">
            @error('name')
        ...
        <div class="mb-3">
            ...
            <input type="string" class="form-control @error('code') is-invalid @enderror" id="code"
